---
title: 'Using MDX'
description: 'Mixing components into Markdown — when it earns its keep, and when plain Markdown wins.'
pubDate: 'Jun 01 2024'
...
<HeaderLink href="https://docs.astro.build/en/guides/integrations-guide/mdx/">
